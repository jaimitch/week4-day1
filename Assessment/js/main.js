...
/*************************************************************************************
------------ ANSWER -------------------
Var x is outside of the function so it is the global variable.  Var y is inside the variable so it is the local variable.

Console.log(y) would print undefined because it is set to print before the y variable is created.
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
There is no console.log(y).  Console.log(x) will return undefined
**************************************************************************************/
...
inside the IFEE 4 would be logged outside it would throw a reference error.  Because it is housed inside the IFEE the variable add is protected from being accessed anywhere else outside of the function.
